...
def build_step_script_source(
    ...
    if system_dependencies:
        ...
        script_parts.extend([
            ...
            "  # Use nix-portable with nix-shell (more reliable than nix-env)",
            "  set +e  # Temporarily disable exit on error to capture output",
            "  echo \"Preparing $dep (this may take a few minutes on first run)...\"",
            "  # Timeout after 10 minutes to prevent hanging",
            "  INSTALL_OUTPUT=$(timeout 600 nix-portable nix-shell -p $dep --run 'echo ready' 2>&1)",
            "  INSTALL_STATUS=$?",
            ...
            "        echo -e \"\\033[0;34m[NIX CACHE]\\033[0m \\033[0;32m✓\\033[0m $dep installed from \\033[1;32mLOCAL CACHE\\033[0m (0 MiB download)\"",
            "      else",
            "        echo -e \"\\033[0;34m[NIX CACHE]\\033[0m \\033[0;31m✗\\033[0m $dep downloaded from \\033[1;31mEXTERNAL\\033[0m: $DOWNLOAD_SIZE (cache.nixos.org)\"",
            "      fi",
            "    elif echo \"$INSTALL_OUTPUT\" | grep -q \"copying path.*from.*cache.nixos.org\"; then",
            "      echo -e \"\\033[0;34m[NIX CACHE]\\033[0m \\033[0;31m✗\\033[0m $dep downloaded from \\033[1;31mEXTERNAL\\033[0m (cache.nixos.org)\"",
            "    else",
            "      echo -e \"\\033[0;34m[NIX CACHE]\\033[0m \\033[0;32m✓\\033[0m $dep installed from \\033[1;32mLOCAL CACHE\\033[0m (no download detected)\"",
            "    fi",
            ...
            "done",
            "",
            "# Build nix-shell command with all system dependencies for execution",
